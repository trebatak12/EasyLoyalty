            ...
            >
              ...
              <CardContent className="p-6 text-center min-h-[480px] flex flex-col justify-between">
                <div className="flex-1 flex flex-col">
                  ...
                  <div className="mb-6">
                    <p className="text-4xl font-bold text-stone-800 mb-3 leading-tight">
                  ...
                  <div className="bg-stone-50 rounded-2xl p-4 mb-8 flex-1 flex flex-col justify-center">
                    ...
                    <p className="text-3xl font-bold text-stone-800 mb-2 leading-tight">{formatCurrency(pkg.total)}</p>
